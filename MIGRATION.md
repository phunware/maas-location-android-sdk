...
1. Open the `build.gradle` from your project and change the implementation statement to `com.phunware.location:location:3.7.6` and then sync the project.
